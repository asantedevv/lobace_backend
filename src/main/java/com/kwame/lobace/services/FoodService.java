...
public class FoodService {
    ...
    public Food findFoodById(Integer id) {
        return foodRepository.findById(String.valueOf(id)).orElse(null);
    }
    ...
    public Food updateFoodById(Integer id, Food food) {
        Food food1 = foodRepository.findById(String.valueOf(id)).orElse(null);
    ...
    public Food deleteFoodById(Integer id) {
        Food food = foodRepository.findById(String.valueOf(id)).orElse(null);
